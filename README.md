...
В вашем эксперименте были опробованы три стратегии:
...
1. Дообучение предобученной модели (ZINC250k) на кастомном датасете
    ...
    * Вывод: Такой подход не подходит для задач, требующих строгого контроля над химическими свойствами

2. Обучение с нуля на кастомном датасете

    * Результат: Большой процент валидных молекул, соответствующих целевым критериям

    * Модель полностью адаптируется под нужное распределение данных
...
<img width="1074" height="633" alt="image" src="https://github.com/user-attachments/assets/1bbf3ebe-35f1-4060-ad14-be0aac7b33a9" />
...
<img width="850" height="617" alt="image" src="https://github.com/user-attachments/assets/a8882025-a939-4d99-8f59-35f5a1e4c261" />
...
Сгенерированные нами молекулы станут серьёзным шагом в разработке эффективных лекарственных молекул против болезни Алцгеймера
